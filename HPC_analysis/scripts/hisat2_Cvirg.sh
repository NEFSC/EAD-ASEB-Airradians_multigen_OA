...
OUTDIR=~/Airradians_F1s_TagSeq/output/hisat2/Cvirginica_map
...
#hisat2-build -f $REFDIR/GCF_002022765.2_C_virginica-3.0_genomic.fna $OUTDIR/Cvirginica_ref
...
for i in ${array[@]}; do
        hisat2 -p 8 --dta -x $OUTDIR/Cvirginica_ref -U ${i} -S ${i}.sam
