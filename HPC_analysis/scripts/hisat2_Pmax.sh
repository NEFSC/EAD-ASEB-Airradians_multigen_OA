#!/bin/bash
#SBATCH --job-name="hisat2_align_Pmaximus"
#SBATCH -t 048:00:00
...
# Objective - align the clean reads to the Cvirgninca reference genome 
...
# before running..
# mkdir(s) as Airradians_F1s_TagSeq/output/hisat2/Cvirginica_map
...
OUTDIR=~/Airradians_F1s_TagSeq/output/hisat2/Pmaximus_map
...
hisat2-build -f $REFDIR/GCF_902652985.1_xPecMax1.1_genomic.fna $OUTDIR/Pmaximus_ref
...
for i in ${array[@]}; do
        hisat2 -p 8 --dta -x $OUTDIR/Pmaximus_ref -U ${i} -S ${i}.sam
