...
database=$1 # first call contains the fasta file you want to blast against (i.e maybe contains more annotation that your reference file)
query=$2 #  second is your fasta of interest  - what you are trying to learn more about through this blast (i.e. accessoin IDs do nothavve annotation and want to ID your genes)

mkdir ./Airradiansdb/

# Make the database - note build a protein database and follow with blastx (nucl query w/ protein database)
diamond makedb --in $1 -d ./Airradiansdb/Airradians_db
...
diamond blastx -d ./Airradiansdb/Airradians_db.dmnd -q $2 -o ./airradians_diamond_out --outfmt 6 
