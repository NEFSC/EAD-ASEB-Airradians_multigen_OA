...
Master_data <- read.csv(file="Data/Clearance_rates/ClearanceRates_MasterData.csv", header=T,stringsAsFactors=FALSE, fileEncoding="latin1") # master data file
...
pdf(paste0("C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/ClearanceRates/20210914_figs_tables/2010914_CR_Boxplots.pdf"), width = 7, height= 6)
print(CR_914_boxplot)
dev.off()
