...
Biodep_Master_F1 <- Biodep_Master_F1 %>% 
                        ...
                        dplyr::mutate(pCO2 = fct_relevel(pCO2, c("500 μatm","800 μatm")))# relevel for plotting!
...
F1_FR_correct_MEANS <- summarySE(Biodep_Master_F1, measurevar="FR_correct", 
                              groupvars=c("Age", "pCO2"))

F1_FR_correct_Plot  <- F1_FR_correct_MEANS %>% 
