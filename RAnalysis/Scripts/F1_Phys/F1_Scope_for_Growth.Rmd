...
F1_Masterfile_2.0 <- merge(Biodep_blanks,F1_Masterfile, by = c("Date", "pH")) %>% 
          dplyr::mutate(
                # RR
                RR_resp_mgO2_hr_bfactorTDW = ((RR_umol_hr_bfactorTDW/1000)*32),# convert umol to mg O2
                RR_Joules_hr               = RR_resp_mgO2_hr_bfactorTDW*14, # convert to joules
                # ER
                ER_mgNH4_bFactorNormTDW = ((ER_umol_hr_bfactorTDW/1000)*18.04), # convert umol to mg NH4
                ER_Joules_hr                       = ER_mgNH4_bFactorNormTDW*24.83, # convert o Joules
