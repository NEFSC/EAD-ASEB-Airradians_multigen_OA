...
meanLength.all <- mean(as.numeric(F1_DryGonad$Shell_length_mm))# 27.22554
...
#assign bfactors
bLength.all <- 4.61 # 6.89 - will all data
bLength.low <- 4.98 # 6.99 - with all data
bLength.mod <- 4.15 # 6.57 - with all data
...
#assign bfactors
bLength.all <- 3.16#3.04 using all data
bLength.low <- 3.25#3.02 using all data
bLength.mod <- 3.01#3.09 using all data
...
#assign bfactors
bLength.all <- 3.23 #2.96 
bLength.low <- 3.27 #2.97
bLength.mod <- 3.19 #2.97
