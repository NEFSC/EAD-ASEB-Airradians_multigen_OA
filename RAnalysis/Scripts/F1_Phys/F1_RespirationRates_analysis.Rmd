...
# pCO2         1  10.53  10.525   6.545 0.0227 *
# Residuals   14  22.51   1.608 
TukeyHSD(mod218)
#                       diff       lwr      upr     p adj
# 800 uatm-500 uatm 1.855416 0.3449731 3.365859 0.0196082

F1_d218 <- (F1_RR_Length_Meanbytank %>% dplyr::filter(Age %in% 218))
t1 <- t.test(x = as.numeric(as.factor(F1_d218$pCO2)), 
       y = F1_d218$resp_umol_hr_bFactorNormLength.MEAN,
       alternative = "two.sided", var.equal = TRUE)
# t = -4.1061, df = 18.58, p-value = 0.000626

library(broom)
library(purrr)

tab <- map_df(list(t1), tidy)[4:6]
tab
0.17386^2
```
...
summary(mod218)
#             Df Sum Sq Mean Sq F value Pr(>F)  
# pCO2         1  87.39   87.39   4.313 0.0567 .
# Residuals   14 283.65   20.26 
