...
RR_master <- read.csv(file="C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/Larvae/RR_calc_raw_larvae.csv", header=T)
...
# sdve plots 
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/Larvae/plots/F3_RR_larvae_2DPF.pdf"), width = 8, height = 24)
ggarrange( (ggarrange(F3_Dinge_BOXPLOT_Parent, F3_Dhinge_BOXPLOT_Offspring, ncol=2)),
           F3_Dinge_BOXPLOT_ParentxOffspring, nrow = 2)
dev.off()
...
### Date 20230412 - 7 DPF (pdays post fertilization)
...
F3_7day_BOXPLOT_Parent <- RR_master_F3_7day %>% 
                            ...
                            ggplot(aes(x = factor(pCO2_parents), 
                                   ...
                                   #scale_colour_manual(values=c("forestgreen","orange")) +
                                   theme_classic() + 
                                   ggtitle("F3 Dhinge 20230412 (parentpCO2)") +
...
F3_7day_BOXPLOT_Offspring <- RR_master_F3_7day %>% 
                              ...
                              ggplot(aes(x = factor(pCO2_offspring), 
                                     ...
                                     geom_point(pch = 19, 
                                                ...
                                                size=1) +
                                     scale_colour_manual(values=c("forestgreen","orange", "purple")) +
                                     ggtitle("F3 Dhinge 20230412 (larvaepCO2)") +
                                     theme_classic() + 
                                     theme(axis.title.y=element_text(size=7),
                                           axis.title.x=element_text(size=7),
                                           axis.text.x=element_text(size=7),
...
F3_7day_BOXPLOT_ParentxOffspring <- RR_master_F3_7day %>% 
                                        ...
                                        ggplot(aes(x = factor(pCO2_parents), 
                                               ...
                                               scale_colour_manual(values=c("forestgreen","orange", "purple")) +
                                               theme_classic() + 
                                               ggtitle("F3 Dhinge 20230412 (larvaepCO2 x parentpCO2)") +
...
# sdve plots 
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/Larvae/plots/F3_RR_larvae_7DPF.pdf"), width = 8, height = 24)
ggarrange( (ggarrange(F3_7day_BOXPLOT_Parent, F3_7day_BOXPLOT_Offspring, ncol=2)),
           F3_7day_BOXPLOT_ParentxOffspring, nrow = 2)
dev.off()
