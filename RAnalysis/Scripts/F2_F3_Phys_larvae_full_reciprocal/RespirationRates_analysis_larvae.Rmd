...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/F3_RR_larvae_indiv.pdf"), width = 8, height = 16)
ggarrange(F3_Dinge_BOXPLOT_Parent, F3_Dinge_BOXPLOT, 
          F3_7day_BOXPLOT_Parent, F3_7day_BOXPLOT, nrow = 4)
dev.off()
```