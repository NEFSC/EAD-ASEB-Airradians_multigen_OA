...
resp.data_merged[35,c(1:6)]   # 	2/2/2022	CH1	run_1_raw.txt  -0.0209	-0.02714124	-0.0271412; data change Lpc to -0.0209
resp.data_merged[40,c(1:6)]   # 	2/2/2022	CH2	run_3_raw.txt	-0.004996976	-0.007234043	-0.007234043; data change Lpc to -0.0124



# 20220202 ch1 run 1  = -0.0209
# 
# 20220202 ch2 run 3 = -0.0124
...
Resp.Master_OM$resp_µmol_L_g_hr <- (Resp.Master_OM$resp_umol_L_hr / 
              (Resp.Master_OM$resp_µmol_L_SL.StzedRate/1000)) # normalize by Dry tissue weight  as to mg O2 L-1 g dry tissue weight-1
