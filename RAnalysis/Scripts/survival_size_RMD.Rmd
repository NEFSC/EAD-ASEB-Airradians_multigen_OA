...
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Survival_Size/Juvenile_ShellLength_density_217DPF.pdf"), width = 8, height = 6)
...
Allboxplot_gonad     <- ggplot(data = TDW_AFDW, aes(x=Treatment, y=Dry_Gonad_weight_g, fill = Treatment)) + 
...
Allboxplot_gonad_prop <- ggplot(data = TDW_AFDW, aes(x=Treatment, y=Gonad_proportion, fill = Treatment)) + 
                          geom_boxplot(alpha = 0.2) + 
                          geom_jitter(position=position_jitter(0.1)) +
                          theme_bw() +
                          #facet_wrap( ~ Date_sampled) + 
...
ggarrange(Allboxplot_gonad, Allboxplot_gonad_prop)

pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Survival_Size/Gonad_dry_weight.pdf"), width = 12, height = 6)
ggarrange(Allboxplot_gonad, Allboxplot_gonad_prop) # print the model diagnostics 
dev.off()
...
CI_AFDW         <- TDW_AFDW %>% dplyr::filter(!Condition_index_TotalADFW_div_length < 0) %>% 
                      dplyr::filter(!Date_sampled %in% '3/2/2022') %>% # 3/2/22 are just the animals used for respiration rate measurements
...
pdf(paste0(filename = "C:/Users/samuel.gurr/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Survival_Size/Condition_indices.pdf"), width = 12, height = 6)
