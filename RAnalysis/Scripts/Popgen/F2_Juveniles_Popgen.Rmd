...
knitr::opts_knit$set(root.dir = "D:/PopGen_Postdoc/F2_Juveniles/") # Sam's
```
...
filename <- read.pcadapt("F2_Juveniles_output.bed", type = "bed")

# table cntiaing the metadata for F1Broodstok
strata <- as.data.frame(
          read.csv("C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Data/Genomics/strata/F2_Juveniles_strata.csv", header = TRUE)
          ) %>%  
...
```{r}
getwd()
my_vcf <- read.vcfR("F2_Juveniles_output.vcf.gz")
