...
=======
library(rPlant)
>>>>>>> 257bc02b3042ccda768454985c46622fb64b0f8b
# library(pegas)
# library(LDlinkR)
...
test <- as.data.frame(clump4me(data         = pH75.bed,
                             ...
                             LD.minMaf      = 0.05, # minumum allele freq threshold (5% - =0.05, etc)
                             outputfilename = pH75))
plot(output_PC1~input_Window , data=test) # window of 100?
...
## F1 v F3 low v Mod
test <- as.data.frame(clump4me(data         = F1F3.bed,
                             LD.thr         = 0.1, # r squares
                             LD.K           = 4, # number of PCAs
                             LD.minMaf      = 0.05, # minimum allele freq threshold (5% - =0.05, etc)
                             outputfilename = F1F3))
plot(output_PC1~input_Window , data=test) # window of 1000?
F1F3.LDdiagnostics <- pcadapt(F1F3.bed, 
                            K = 20, 
                            LD.clumping = list(size = 1000, thr = 0.1), # based clump4me result
                            min.maf= 0.05)
