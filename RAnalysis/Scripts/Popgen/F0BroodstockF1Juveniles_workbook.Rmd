...
clump4me <- function(data, LD.thr, LD.K, LD.minMaf, outputfilename) {
        ...
        for (i in 1:nrow(LD.window_loop)) {
          ...
          loop.table$input_MinMaf    = minMaf
...
X <- as.data.frame(clump4me(data            = F0B_F1JALL_merged.bed,
...
plot(output_PC1~input_Window , data=X)

```

```{r think SNPs and compute PCs}


F0B_F1JuvAll_intersect.LDdiagnostics <- pcadapt(F0B_F1JALL_intersect.bed, 
                                                K = 20, LD.clumping = list(size = 400, thr = 0.1),
                                                min.maf= 0.05)
plot(F0B_F1JuvAll_intersect.LDdiagnostics, option = "screeplot") # Lets try and use K = 2 after SNP thinning 
F0B_F1JuvAll_intersect.LDres <- pcadapt(F0B_F1JALL_intersect.bed, 
                                        K = 5, 
                                        LD.clumping = list(size = 400, thr = 0.1))
par(mfrow = c(1, 2))
for (i in 1:2)
  plot(F0B_F1JuvAll_intersect.LDres$loadings[, i], pch = 19, cex = .3, ylab = paste0("Loadings PC", i))
plot(F0B_F1JuvAll_intersect.LDres)
...
F0B_F1JuvAll_merged.LDdiagnostics <- pcadapt(F0B_F1JALL_merged.bed, K = 20, 
                                             ...
                                             min.maf= 0.05)
plot(F0B_F1JuvAll_merged.LDdiagnostics, option = "screeplot") # Lets try and use K = 3 after SNP thinning 
...
par(mfrow = c(1, 2))
for (i in 1:2)
  plot(F0B_F1JuvAll_merged.LDres$loadings[, i], pch = 19, cex = .3, ylab = paste0("Loadings PC", i))
plot(F0B_F1JuvAll_merged.LDres)
...
F0B_F1JLOW_merged.LDdiagnostics <- pcadapt(F0B_F1JLOW_merged.bed, K = 20, 
                                             ...
                                             min.maf= 0.05)
plot(F0B_F1JLOW_merged.LDdiagnostics, option = "screeplot") # Lets try and use K = 3 after SNP thinning 
...
par(mfrow = c(1, 2))
for (i in 1:2)
  plot(F0B_F1JLOW_merged.LDres$loadings[, i], pch = 19, cex = .3, ylab = paste0("Loadings PC", i))
plot(F0B_F1JLOW_merged.LDres)
...
# INTERSECT DATA :::::::::::::::::::::::::::::::::::::::::::::::::::::::
## data: F0B_F1JuvAll_intersect.res
...
# MERGED DATA ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
## data: F0B_F1JuvAll_merged.LDres , F0B_F1JuvLOW_merge.res F0B_F1JMODERATE_merged.res
plot(F0B_F1JuvAll_merged.LDres, option = "scores", pop = F0BroodF1Juveniles_strata$Gen_Treatment)
plot(F0B_F1JuvAll_merged.LDres, option = "scores", i = 2, j = 3, pop = F0BroodF1Juveniles_strata$Gen_Treatment)
plot(F0B_F1JuvAll_merged.LDres , option = "manhattan")

## * F0 Broodstock w/ F1 Juveniles LOW
plot(F0B_F1JLOW_merged.LDres, option = "scores", pop = F0F1_strata_pH8$Gen)
plot(F0B_F1JLOW_merged.LDres, option = "scores", i = 3, j = 4, pop = F0F1_strata_pH8$Gen)
