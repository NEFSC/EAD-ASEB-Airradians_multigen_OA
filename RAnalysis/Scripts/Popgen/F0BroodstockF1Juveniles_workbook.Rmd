...
F0BroodF1Juveniles_strata   <- read.csv("C:/Users/samuel.gurr/Documents/strata.csv", sep =',', header=FALSE) %>% 
...
F0F1_strata_pH75           <- F0F1_strata %>% dplyr::filter(!Treatment %in% 'Low') # keep modrate, pH 75
F0F1_strata_pH8            <- F0F1_strata %>% dplyr::filter(!Treatment %in% 'Moderate') # keep modrate, pH 75
```
