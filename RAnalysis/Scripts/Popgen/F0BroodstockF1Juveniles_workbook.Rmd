...
plot(F0B_F1JuvAll_intersect.diagnostic, option = "screeplot") # looks like 8
F0B_F1JuvAll_intersect.res             <- pcadapt(F0B_F1JALL_intersect.bed, K = 8) # assign
...
plot(F0B_F1JuvAll_merge.diagnostic, option = "screeplot") # looks like 5
F0B_F1JuvAll_merge.res                 <- pcadapt(F0B_F1JALL_merged.bed, K = 5) # assign
...
plot(F0B_F1JuvLOW_merge.diagnostic, option = "screeplot") # looks like 5
F0B_F1JuvLOW_merge.res                 <- pcadapt(F0B_F1JLOW_merged.bed, K = 5) # assign
...
F0B_F1JuvAll_intersect.LDdiagnostics <- pcadapt(F0B_F1JALL_intersect.bed, 
                                                ...
                                                min.maf= 0.05)
plot(F0B_F1JuvAll_intersect.LDdiagnostics, option = "screeplot") # Lets try and use K = 5 after SNP thinning 
...
F0B_F1JMODERATE_merged.LDdiagnostics <- pcadapt(F0B_F1JMODERATE_merged.bed, K = 20, 
                                             LD.clumping = list(size = 300, thr = 0.1),
                                             min.maf= 0.05)
plot(F0B_F1JMODERATE_merged.LDdiagnostics, option = "screeplot") # Lets try and use K = 4 after SNP thinning 
F0B_F1JMODERATE_merged.LDres <- pcadapt(F0B_F1JMODERATE_merged.bed, 
                                        K = 4, 
                                        LD.clumping = list(size = 300, thr = 0.1),
                                        min.maf=0.05)
```
