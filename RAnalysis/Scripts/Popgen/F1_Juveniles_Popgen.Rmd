...
treatment.names <- strata_df$Treatment
...
```{r}
getwd()
my_vcf <- read.vcfR("C:/Users/samuel.gurr/Documents/F1Juveniles_Merged.vcf.gz")
...
ld_genind <- vcfR2genind(ld_filtered_vcf_LD)
# assign metadata to these loci 
strata(ld_genind) <- strata_df
setPop(ld_genind) <- ~Treatment
