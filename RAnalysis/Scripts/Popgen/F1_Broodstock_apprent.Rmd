...
# F1 Juveniles pH 75
F1J_pH75_raw_geno <- read.table('HPC_analysis/output/lcWGS/angsd/F1_Juveniles_75/F1Juveniles_pH75_doMaf1_minMaf0.05_majorminor4_minind38_minD5x190_maxD20x760minDind5_maxDind150_minq30_minmapQ.geno.gz')  
...
```{r run apparent}
apparentOUT <- apparent(F1Juv_pH8_parentage_df[,c(1:ncol(F1Juv_pH8_parentage_df))], MaxIdent=0.10, alpha=0.01, nloci=100, self=TRUE, plot=FALSE, Dyad=FALSE)
