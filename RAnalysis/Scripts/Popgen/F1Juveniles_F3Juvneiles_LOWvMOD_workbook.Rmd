...
F1F3_merged.bed        <- read.pcadapt(paste0(path,"F1F3_LOWvMOD_merge.vcf.gz"), type = "vcf",type.out = "bed") # 96,703 variants
...
F1F3_merged_longcontigs.bed        <- read.pcadapt(paste0(path,"F1F3_LOWvMOD_merge_longcontigs.vcf.gz"), type = "vcf",type.out = "bed") # 48,120 variants
