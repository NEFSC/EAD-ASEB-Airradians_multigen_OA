...
# all data
test <- as.data.frame(clump4me(data         = F1F3_merged.bed,
...
F1F3_merged.LDres <- pcadapt(F0B_F1JALL_intersect.bed, 
                                        K = 8, 
                                        LD.clumping = list(size = 850, thr = 0.1), 
                                        min.maf= 0.05)
ggarrange( (plot(F1F3_merged.res, option = "manhattan")),
           (plot(F1F3_merged.LDres, option = "manhattan")),nrow=2)
