...
F2_RR_Length_Meanbytank_LvH     <- RR_formatted_F2s %>% 
                            ...
                            dplyr::arrange(sort(Age)) %>% 
                            dplyr::filter(!Date %in% '9/22/2022')
unique(F2_RR_Length_Meanbytank_LvMH$Date)  # "1/31/2023"  "11/16/2022" "2/23/2023"  "3/27/2023"  "8/30/2022"                     
...
write.csv( (AOVdf_total %>% dplyr::arrange(sort(Date))), "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/F2/F2_RR_LENGTH_Statistics.csv")
