...
print(ggarrange(F2s.BOXPLOT_Length_bfactor.MEAN, F2_RR_Length_MeanSE, ncol = 2)) # print the model diagnostics 
dev.off()


pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/F2/F2_RR_LENGTH_bfactor_meanSE.pdf"), width = 4, height = 4)
print(ggarrange(F2_RR_Length_MeanSE)) # print the model diagnostics 
dev.off()
...
# (2) t.test 
Ttest_Dates       <- as.data.frame(unique(F2_RR_Length_Meanbytank$Date)) # call a list to loop in 
