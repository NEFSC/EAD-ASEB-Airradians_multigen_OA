...
nrow(subset(RespirationRates_adj, 
            !(uniqueID %in% Biodeposition_adj$uniqueID))) # now it is 8 ever since i ran biodep b factors -  previously was 2 discrepancies, these are the removed outliers from biodep
```
...
F2_Masterfile <- merge(RR_ER_merge, Biodeposition_adj, 
                  ...
                  dplyr::select(c(Date, 
                                  ...
                                  AR,
                                  AE))
nrow(F2_Masterfile) # now 55 every since biodep b fators - was preciously 59 rows - as expected!!!!!
# View(F2_Masterfile)
...
# pCO2         2  44662   22331   7.749 0.00405 **
# Residuals   17  48987    2882 
...
shapiro.test(resid(TwoWayANOVA_LvM)) # 0.03488 pass 
leveneTest(TwoWayANOVA_LvM) # 0.002684  **

scheirerRayHare(SFG ~ pCO2 * Age, data = F2_SGF_Means_by_tank_LvM)
#           Df  Sum Sq       H p.value
# pCO2       1  740.07  8.9525 0.00277
# Age        2 1073.26 12.9830 0.00152
# pCO2:Age   2   14.35  0.1735 0.91689
# Residuals 25  825.01    
SRH_LvM_Age = dunnTest(SFG ~ Age,
              data = F2_SGF_Means_by_tank_LvM,
              method="bh")      # Adjusts p-values for multiple comparisons;
SRH_LvM_Age
# 167 - 190	3.940527	0.0000813029	0.0002439087	
# 167 - 222	2.781147	0.0054167216	0.0081250824	
# 190 - 222	-1.345376	0.1785037179	0.1785037179	
...
F2_SGF_Means_by_tank_LvH$GROUPvar <- F2_SGF_Means_by_tank_LvH$Age 
