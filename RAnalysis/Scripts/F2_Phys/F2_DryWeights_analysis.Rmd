...
meanLength.all <- mean(as.numeric(F2_DryGonad$Shell_length_mm))# 34.35643
seLength.all   <- sd(F2_DryGonad$Shell_length_mm)/sqrt(length((F2_DryGonad$Shell_length_mm))) # 0.4086302
...
meanLength.all <- mean(F2_DryAdductor$Shell_length_mm) # 34.35643
seLength.all   <- sd(F2_DryAdductor$Shell_length_mm)/sqrt(length((F2_DryAdductor$Shell_length_mm))) # 0.4086302
# age range of animals 
