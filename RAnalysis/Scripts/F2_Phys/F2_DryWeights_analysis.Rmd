...
Somatic_final_plot <- F2_DrySomatic.bfactor.long.MEANS_master %>% 
                          ...
                          stat_summary(fun.min = function(x) mean(x) - sd(x)/sqrt(length(x)), 
                                        ...
                                        geom = 'errorbar', width = 0.25, size = 1,
                                        position = position_dodge2(width = 0.5)) + 
                          labs(title="Somatic: Length b factor all", x ="Age (dpf)", y = "Dry Somatic (mg Lengthbfactor_all)") +
                          theme_classic() +
                          theme(panel.grid.major = element_blank(), 
                                panel.grid.minor = element_blank(), 
                                axis.text.x = element_text(angle = 0, vjust = 0.5, hjust=1),
...
Shell_final_plot <- F2_DryShell.bfactor.long.MEANS_master %>% 
                          ...
                          stat_summary(fun.min = function(x) mean(x) - sd(x)/sqrt(length(x)), 
                                        ...
                                        geom = 'errorbar', width = 0.25, size = 1,
                                        position = position_dodge2(width = 0.5)) + 
                          labs(title="Shell: Length b factor pCO2", x ="Age (dpf)", y = "Dry Shell (mg Lengthbfactor_pCO2)") +
                          theme_classic() +
                          theme(panel.grid.major = element_blank(), 
                                panel.grid.minor = element_blank(), 
                                axis.text.x = element_text(angle = 0, vjust = 0.5, hjust=1),
