  ...
  dplyr::mutate(volume = 
            ...
            case_when(filetype == "LoLigo_data" & Date == '9/14/2021' ~ 1.7,
                     ...
                     filetype == "SDR_data" ~ 0.08)) %>% # 24-well plate - 80 ul (0.08 mL)
                                   ...
                                   # filetype == "SDR_data" & Date %in% ('8/30/2022') ~ 0.08)) %>% # 24-well plate - 80 ul (0.08 mL)
...
print(Resp.outliers) # 34 samples have negative values when correcting for the blank, meaning the blank rate was GREATER than the sample resp value
View(Resp.Master_OM)
```
...
Resp.Master_OM$resp_µmol_L_mg_WDW_hr <- (Resp.Master_OM$resp_umol_L_hr / # multiple by 1000 to convert mmol/ O2 to umol/L O2
