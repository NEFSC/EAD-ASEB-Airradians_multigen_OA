...
Resp.Master_OM <- Resp.Master[!is.na(Resp.Master$Length_um),] %>% 
  ...
  dplyr::mutate(volume = 
            ...
            case_when(
                      ...
                      # F2 data - what were the chamber volumes for the 2/1/2020 data????????
                      
                      
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH1' ~ 198.2, # F2 data
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH2' ~ 212.5,
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH3' ~ 209.8,
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH4' ~ 211.8,
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH5' ~ 212.6,
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH6' ~ 212.8,
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH7' ~ 213.5, 
                      filetype == "LoLigo_data" & Date %in% c('2/23/2022') & Channel == 'CH8' ~ 212)) %>% # F2 data
  # BIOVOLUME 
