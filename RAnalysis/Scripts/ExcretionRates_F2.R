...
Excretion_data <- read.csv(file="Data/Physiology/Excretion_rates/F2/cumultative_raw/F2_Excretion_master.csv", header=T,stringsAsFactors=FALSE, fileEncoding="latin1") # master data file
...
list(unique(Excretion_data$Date)) # 0221116 20230131 20230223
...
meanTDW <- mean(as.numeric(Size_data_2$Dry_Tissue_weight)) # 0.3062667
...
write.csv(Excretion_master, "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/ExcretionRates/F2/F2_ExcretionRates_master.csv")
