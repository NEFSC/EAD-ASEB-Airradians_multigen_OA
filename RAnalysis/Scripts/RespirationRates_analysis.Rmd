...
# summary: 
# Length b factor total = 1.77
# Length b factor pCO2 high = 1.84
# Length b factor pCO2 low = 1.76
...
for (i in 1:nrow(ANOVA_Dates)) {
  ...
  data_loop     <- RR_formatted_F1s %>% 
                          ...
                          dplyr::select(Date, pCO2, resp_umol_L_hr_bFactorNormWDW) %>% 
                          na.omit()
...
write.csv(AOVdf_total, "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/Respiration_ANOVA_table.csv")
