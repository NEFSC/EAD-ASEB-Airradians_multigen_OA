...
# summary: 
# TDW b factor total = 0.797
# TDW b factor pCO2 high = 0.813
# TDW b factor pCO2 low = 0.77
...
# summary: 
# TDW b factor total = 0.863
# TDW b factor pCO2 high = 0.813
# TDW b factor pCO2 low = 0.88 # two outliers removed here
...
# ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# EXTRAPOLATE TDW TO SMALLER SIZES  + CALC B FACTOR FOR TDW AND MO2 ::::::::::::::::::::::::::::::
...
# definitely strange at lower values, likely beneficial to attempt to use length for the allometric equation!
...
# summary: 
# TDW b factor total = 1.85
# TDW b factor pCO2 high = 1.74
# TDW b factor pCO2 low = 2.12
...
RR_master_without_WDW                   <- RR_master[is.na(RR_master$whole_Dry_weight),] 

RR_master_without_WDW$whole_Dry_weight <- 10^(-9.71+3.11*(log(RR_master_without_WDW$Length_um/1000))) # Calculate a TDW value based on the Local Polynomial Regression Fitting geom_smooth EQ  (file:///C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Survival_Size/TissueDryWeight_v_Length.pdf)
RR_master_with_WDW                      <- RR_master[!is.na(RR_master$whole_Dry_weight),] # call the data that does have TDW to merge with the updated data 

RR_master_newWDW                        <- rbind(RR_master_without_WDW, RR_master_with_WDW) # we now have a new dataset with TDW for the smaller animals and those did not have it measured

# repeat the process above for metabolic scaling 
RR_master_newWDW_OM            <- RR_master_newWDW %>% filter(!is.na(resp_umol_L_hr))
RR_master_newWDW_OM$log10_VO2  <- log10(as.numeric(RR_master_newWDW_OM$resp_umol_L_hr)) # assign resp value
RR_master_newWDW_OM$log10_WDW  <- log10(as.numeric(RR_master_newWDW_OM$whole_Dry_weight)) # assign length value 
summary(lm(RR_master_newWDW_OM$log10_VO2~RR_master_newWDW_OM$log10_WDW)) # 0.71092 == b factor

RR_master_newWDW_OM


MO2_b.factorWDW_PLOT <- RR_master_newWDW_OM %>% 
                       ggplot(aes(x=log10_WDW, y=log10_VO2)) +
                          geom_point() +
                          theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())+ 
                          scale_x_continuous(name ="log10_BodyMass; WDW in g") +
...
pdf(paste0(filename = "C:/Users/samjg/Documents/Github_repositories/Airradians_multigen_OA/RAnalysis/Output/Respiration/metabolic_scaling/MetabolicScaling_Boxplots_bFactor_TDW.pdf"), width = 8, height = 8)
