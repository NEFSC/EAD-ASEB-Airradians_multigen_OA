...
# summary: 
# TDW b factor total = 0.696
# TDW b factor pCO2 high = 0.684
# TDW b factor pCO2 low = 0.708 # two outliers removed here
...
# summary: 
# Length b factor total = 2.22
# Length b factor pCO2 high = 2.22
# Length b factor pCO2 low = 2.22
...
# WDW b factor total = 0.771
# WDW b factor pCO2 high = 0.764
# WDW b factor pCO2 low = 0.782
...
RR_formatted_F1s.length <- RR_formatted_F1s %>% 
  ...
  dplyr::mutate(resp_umol_L_hr_bFactorNormLength.MEAN = (resp_umol_L_hr) * ((Length_mm/meanLength)^bLength) ) %>% # RStd = (Lexp/Lstd)1.77 * RRexp 
  dplyr::mutate(resp_umol_L_hr_bFactorNormLength.MEDIAN = (resp_umol_L_hr) *  ((Length_mm/medianLength)^bLength) ) # RStd = (Lexp/Lstd)1.77 * RRexp
...
# run anova and two-way anova for the mean stand (same as the median!)
``` {r stats F1s, Length b factor norm - MEAN}
unique(RR_formatted_F1s$Date) # 2021-09-14 2021-09-30 2021-10-26 2022-02-02 2022-03-01 2022-09-22
# f1s data
...
# pCO2          1 1.97e-26 1.973e-26   4.619 0.0335 *
# Date          1 5.00e-28 4.590e-28   0.107 0.7437  
# pCO2:Date     1 4.00e-28 3.720e-28   0.087 0.7685  
# Residuals   129 5.51e-25 4.272e-27  
